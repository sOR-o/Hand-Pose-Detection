...
labels = ['bathroom', 'bye', 'bye', 'doing', 'fine', 'fine', 'good', 'hello', 'hello', 'help', 'how', 'live', 'love', 'me', 'me', 'much', 'name', 'ques', 'stop', 'thanku', 'thanku', 'thumbsup', 'thumbsup', 'what', 'where', 'you','r']
...
# Create a placeholder container for the text box
    ...
    if camera_active:
        ...
        try:
            if results.multi_hand_landmarks:
                with processing:
                        index = (index) % 5
                        st.write("**processing** " + dots[index])
                        index = (index + 1) % 5
                        time.sleep(0.5)  
                ...
                if (left_hand_detected and right_hand_detected) or left_hand_detected or right_hand_detected:                    
                    with text_container:
                        # Update the text content
                        text_content += "testing text \n"
